...
export default function HeroSection() {
  return (
    <div className="w-full hero-gradient py-20 px-5 lg:px-10 flex items-center justify-between">
       <div className="container mx-auto flex justify-between items-center">
         <div className="flex flex-col gap-4 w-[605px] pr-2">
            ...
            <h1 className="text-4xl lg:text-[48px] lg:leading-15 fontCreateRound lg:w-[538px]">Safe Support Whenever You Need Someone To Talk To.</h1>

            <p className="lg:text-[18px] fontDMSans">Chat Anonymously with Mindora for guidance, emotional support and Health-related conversations -Without judgment, without sign-ups.</p>
